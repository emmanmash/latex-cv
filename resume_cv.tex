...
\name{Emmanuel}{Mashandudze}
\address{19 Prince Charles Street, Southfield, Cape Town, 7800}
\mobile{(+27) 78 92 00 150}

\email{emmashepi@gmail.com}
\github{emmanmash}
\linkedin{emmanuel-mashandudze-b927b15/}
%\skype{emmwafadzi}
...
%\xing{xing name}
\extrainfo{SA-ID: 850312****186} % Other text you want to include on this line

\position{Software Engineer{\enskip\cdotp\enskip}Business Intelligence Developer} % Your expertise/fields

\makecvfooter{\today}{Emmanuel Mashandudze~~~·~~~Résumé}{\thepage} % 
